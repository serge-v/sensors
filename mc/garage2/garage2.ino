/*
garage2: garage with open door sensor and sleep with watchdog
...
Release on attiny85:
      ...
      RFM12SB 433MHz
          ...
          SMD
          ------------------------
[12] -----| SDO  OUT     nSEL IN |--------[4.7K]-- [10]
 [2] -----| nIRQ OUT     SCK  IN |--------[4.7K]-- [13]
          | DATA I/O     SDI  IN |--------[4.7K]-- [11]
          | DCLK OUT     nINT IN |
          | CLK  OUT     GND     |
          | nRES I/O     VDD     | -- 3.3V
          | GND          ANT     | -- 1/4 wave = 164.7mm
          ------------------------
